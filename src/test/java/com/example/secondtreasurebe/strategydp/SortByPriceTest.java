...
public class SortByPriceTest {
    ...
    void setUp() {
        ...
        listing2.setPrice(BigDecimal.valueOf(199000));
        ...
        listing3.setPrice(BigDecimal.valueOf(399000));
    ...
    public void testSortByPrice() {
        ...
        assertEquals(BigDecimal.valueOf(399000), sortedListings.get(2).getPrice());
    }
}